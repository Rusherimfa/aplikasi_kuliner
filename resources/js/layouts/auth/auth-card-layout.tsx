...
export default function AuthCardLayout({
    ...
    return (
        <div className="relative flex min-h-svh flex-col items-center justify-center gap-6 bg-[#FAFAFA] dark:bg-[#0A0A0B] p-6 md:p-10 transition-colors duration-500 overflow-hidden font-['Inter',sans-serif]">
            ...
            <div className="pointer-events-none absolute top-[-10%] right-[-10%] h-[600px] w-[600px] rounded-full bg-amber-500/5 blur-[120px]" />
            <div className="pointer-events-none absolute bottom-[-10%] left-[-10%] h-[500px] w-[500px] rounded-full bg-amber-600/5 blur-[100px]" />
                    ...
                    <Card className="glass-card border-border dark:border-white/5 bg-white/70 dark:bg-white/[0.02] rounded-[2.5rem] shadow-2xl backdrop-blur-3xl overflow-hidden">
                        <CardHeader className="px-10 pt-10 pb-2 text-center space-y-3">
                            <motion.div
                                ...
                                className="mx-auto inline-flex items-center gap-2 rounded-full border border-amber-500/20 bg-amber-500/5 px-4 py-1.5 text-[10px] font-black tracking-[0.3em] text-amber-500 uppercase glow-amber"
                            >
                                Security Gate
                            </motion.div>
