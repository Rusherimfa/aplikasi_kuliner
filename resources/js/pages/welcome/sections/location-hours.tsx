...
export default function LocationHours() {
    ...
    return (
        <section 
            id="location-hours"
            ref={containerRef}
            className="relative py-32 bg-[#FFF9F2] dark:bg-neutral-900/50 transition-colors duration-700 overflow-hidden"
        >
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
                    ...
                    <motion.div 
                        ...
                        className="bg-white dark:bg-neutral-900/40 backdrop-blur-md rounded-[3rem] p-12 lg:p-16 shadow-[0_30px_60px_-15px_rgba(180,140,100,0.1)] border border-white/40 dark:border-white/5 flex flex-col justify-between"
                    >
                        <div>
                            <div className="flex items-center gap-4 mb-10">
                                ...
                                <h2 className="font-serif text-4xl text-slate-900 dark:text-white">Jam Operasional</h2>
                            </div>

                            <div className="space-y-10">
                                <div className="group">
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-primary/60 mb-3 font-sans">Senin — Jumat</p>
                                    <p className="font-serif text-3xl text-slate-800 dark:text-neutral-200 group-hover:text-primary transition-colors duration-500">08:00 AM — 10:00 PM</p>
                                </div>
                                
                                <div className="group">
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-primary/60 mb-3 font-sans">Sabtu — Minggu</p>
                                    <p className="font-serif text-3xl text-slate-800 dark:text-neutral-200 group-hover:text-primary transition-colors duration-500">09:00 AM — 11:00 PM</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 1, ease: "easeOut" }}
                        className="bg-white dark:bg-neutral-900/40 backdrop-blur-md rounded-[3rem] p-12 lg:p-16 shadow-[0_30px_60px_-15px_rgba(180,140,100,0.1)] border border-white/40 dark:border-white/5 flex flex-col"
                    >
                        <div className="flex items-center gap-4 mb-10">
                            <div className="h-12 w-12 rounded-2xl bg-primary/10 text-primary flex items-center justify-center">
                                <MapPin size={24} strokeWidth={1.5} />
                            </div>
                            <h2 className="font-serif text-4xl text-slate-900 dark:text-white">Lokasi Kami</h2>
                        </div>

                        <p className="font-serif text-2xl text-slate-600 dark:text-neutral-400 leading-relaxed mb-12 italic">
