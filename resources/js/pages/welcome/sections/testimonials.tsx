        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-28">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-20 text-center">
                    <span className="mb-4 inline-block rounded-full border border-amber-500/20 bg-amber-500/10 px-4 py-1 text-xs font-semibold tracking-widest text-amber-400 uppercase">
                        Cerita Tamu
                    </span>
                    <h2 className="mb-4 font-['Playfair_Display',serif] text-4xl font-bold text-white md:text-5xl">
                        Apa Kata Tamu Kami
                    </h2>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    {TESTIMONIALS.map((t) => (
                        <div
                            key={t.id}
                            className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/8 bg-white/5 p-8 backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:border-amber-500/20 hover:bg-white/8"
                        >
                            {/* Top glow line */}
                            ...
                            {/* Quote text */}
                            <p className="mb-8 flex-1 text-base leading-relaxed text-white/70 italic">
                                "{t.quote}"
                            </p>
