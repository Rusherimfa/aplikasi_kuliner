...
export default function Navbar({ auth, dashboardUrl, mobileMenuOpen, setMobileMenuOpen }: NavbarProps) {
    ...
    return (
        <>
            ...
            <div className={`fixed inset-0 z-[100] bg-background/98 backdrop-blur-3xl p-6 transition-all duration-700 ease-in-out md:hidden ${mobileMenuOpen ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full pointer-events-none'}`}>
