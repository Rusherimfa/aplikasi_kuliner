                        ...
                        {filteredMenus.length > 0 ? (
                            ...
                            >
                                {filteredMenus.map((item, index) => (
                                    ...
                                    >
                                        <div className="glass-card relative flex h-full flex-col overflow-hidden rounded-[2.5rem] bg-white dark:bg-white/5 border-border dark:border-white/10 transition-all duration-700 hover:-translate-y-3 hover:border-orange-500/30 hover:shadow-2xl shadow-orange-500/5 active:scale-[0.98]">
                                            {/* Media Area */}
                                            ...
                                            <div className="flex flex-1 flex-col p-8 pt-4">
                                                <div className="mb-4 flex flex-col items-start gap-1">
                                                    <h3 className="text-xl font-black text-slate-900 dark:text-white tracking-tight leading-tight group-hover:text-orange-500 transition-colors">
                                                        {item.name}
                                                    </h3>
                                                ...
                                                <p className="mb-8 line-clamp-2 flex-1 text-sm font-medium leading-relaxed text-slate-500 dark:text-neutral-500">
