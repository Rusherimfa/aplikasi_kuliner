        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-8 p-8 max-w-7xl mx-auto w-full">
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="text-3xl font-black tracking-tight text-foreground font-['Playfair_Display',serif]">Boutique <span className="italic opacity-40">Intelligence</span></h1>
                    <p className="text-sm text-muted-foreground font-medium">Real-time performance metrics and gastronomy insights.</p>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <StatCard 
                        ...
                        subtitle={`${stats.userStats.customers} loyal customers`}
                        icon={Users}
                        color="blue"
                    />
                    <StatCard 
                        title="Loyalty Economy" 
                        value={formatRupiah(stats.loyaltyStats.total_discounts_given)} 
                        subtitle={`${stats.loyaltyStats.total_points_redeemed} points redeemed`}
                        icon={Coins}
                        color="emerald"
                    />
                    <StatCard 
                    ...
                    <div className="rounded-[2.5rem] border border-slate-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-8 shadow-sm">
                        ...
                        <div className="space-y-6">
                            {stats.recentReviews.length === 0 ? (
                                <p className="text-sm text-muted-foreground italic text-center py-10">Waiting for guest testimonials...</p>
                            ) : (
